        ...
        <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '4px' }}>
          <button
            ...
            style={{
              ...
              backgroundColor:
                selectedCategory === 'ALL' ? 'var(--dorzak-primary)' : 'var(--color-surface)',
          ...
          {categories.map((c) => (
            <button
              ...
              style={{
                ...
                border: '1px solid var(--color-border)',
                backgroundColor:
                  selectedCategory === c.name ? 'var(--dorzak-primary)' : 'var(--color-surface)',
            ...
            items.map((item) => (
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                    {money(item.variant?.price ?? item.product.price)} each
                  </span>
                </div>
                ...
                <strong style={{ width: '72px', textAlign: 'end', fontSize: '0.9rem' }}>
                  {money((item.variant?.price ?? item.product.price) * item.quantity)}
                </strong>
                <button
                  onClick={() => removeItem(item.lineKey)}
                  style={{ color: 'var(--dorzak-danger)', marginLeft: '8px' }}
                >
