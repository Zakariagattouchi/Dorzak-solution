...
const ar: Record<string, string> = {
  ...
  'Manage inventory items, pricing, variants, and stock levels': 'إدارة المنتجات والأسعار والخيارات ومستويات المخزون',
  'Product': 'المنتج',
  'Category': 'الفئة',
  'Price': 'السعر',
  ...
  'Organize products for POS and online store display': 'تنظيم المنتجات لنقطة البيع والمتجر الإلكتروني',
  'Orders & Sales History': 'سجل الطلبات والمبيعات',
  'Complete history of all transactions — click an order to view the receipt': 'سجل كامل لجميع المعاملات — اضغط على الطلب لعرض الإيصال',
  ...
  'Complete audit log of all sales with payment breakdowns, discounts, and tax details': 'سجل تدقيق كامل للمبيعات وطرق الدفع والخصومات والضرائب',
  ...
  'Revenue breakdown, cash vs card flows, tax collected, and profit summary': 'تفاصيل الإيرادات والتدفقات النقدية والبطاقات والضرائب والأرباح',
  'Daily': 'يومي',
  'Weekly': 'أسبوعي',
  'Monthly': 'شهري',
  ...
  'Sales trends, revenue breakdown, payment methods, and inventory health': 'اتجاهات المبيعات وتفاصيل الإيرادات وطرق الدفع وصحة المخزون',
  'Today': 'اليوم',
  'Week': 'الأسبوع',
  'Month': 'الشهر',
  'All Time': 'كل الوقت',
  ...
  'Configure your public web catalog, online ordering wizard, banner, and WhatsApp integration': 'إعداد الكتالوج العام والطلب الإلكتروني والواجهة وربط واتساب',
  ...
  'Manage team members, assign roles, and control access permissions': 'إدارة أعضاء الفريق والأدوار وصلاحيات الوصول',
  ...
  'Legal business details, owner name, and registered address': 'البيانات القانونية واسم المالك والعنوان المسجل',
...
Object.assign(ar, {
  ...
  'Select a photo to auto-fill product details using AI recognition.': 'اختر صورة لتعبئة بيانات المنتج تلقائياً باستخدام الذكاء الاصطناعي.',
  ...
  'Detailed description for receipt and online storefront catalog...': 'وصف تفصيلي للإيصال وكتالوج المتجر الإلكتروني...',
  ...
  'Search customers by name, email or phone...': 'ابحث عن العملاء بالاسم أو البريد الإلكتروني أو الهاتف...',
  'BALANCE': 'الرصيد',
  'ADDRESS': 'العنوان',
  ...
  'Publish your online store for public customer orders': 'انشر متجرك الإلكتروني لاستقبال طلبات العملاء.',
  ...
  'Customers scan a table QR code, open the storefront, and place an order linked to that table.': 'يمسح العميل رمز QR للطاولة، ويفتح المتجر، ويرسل طلباً مرتبطاً بهذه الطاولة.',
  'Dine-in table QR codes': 'رموز QR لطاولات المطعم',
  'Enter how many tables you have. Dorzak will generate one QR code per table and attach the table number to every order.': 'أدخل عدد الطاولات لديك. سيولد دورزاك رمز QR لكل طاولة ويربط رقم الطاولة بكل طلب.',
  ...
  'of unlimited staff users active • Upgrade anytime to add more': 'من عدد غير محدود من الموظفين النشطين • يمكنك الترقية في أي وقت',
  'OWNER': 'المالك',
  'MANAGER': 'المدير',
  ...
  'Manager': 'مدير',
  'Remove': 'إزالة',
  'Invite staff members and assign role-based access permissions': 'ادعُ الموظفين وحدد صلاحيات الوصول حسب الدور.',
  '+ Invite Staff Member': '+ دعوة موظف',
  ...
  'Your WhatsApp number is used for direct customer order notifications from the online catalog.': 'يُستخدم رقم واتساب لإرسال إشعارات طلبات العملاء مباشرة من الكتالوج الإلكتروني.',
  ...
  'Configure sales tax rates applied to POS and online transactions': 'اضبط نسب ضريبة المبيعات المطبقة على نقطة البيع والمعاملات الإلكترونية.',
  'Charge Sales Taxes': 'تحصيل ضريبة المبيعات',
  'Apply tax rate to all taxable products in sales and receipts': 'تطبيق نسبة الضريبة على جميع المنتجات الخاضعة لها في المبيعات والإيصالات.',
  ...
  "Enable this if your product prices already include the tax amount (prices shown to customers won't change)": 'فعّل هذا الخيار إذا كانت أسعار المنتجات تشمل الضريبة مسبقاً؛ لن تتغير الأسعار المعروضة للعملاء.',
  'Personalize the header and footer text shown on printed and emailed receipts': 'خصّص نص رأس وتذييل الإيصالات المطبوعة والمرسلة بالبريد.',
  'Receipt Header Message': 'رسالة رأس الإيصال',
  'Appears at the top of every receipt, above the order items': 'تظهر أعلى كل إيصال قبل عناصر الطلب.',
  ...
  'Show your business logo at the top of printed receipts': 'إظهار شعار النشاط أعلى الإيصالات المطبوعة.',
  ...
  'Automatically open the print dialog after completing a sale at the POS': 'فتح نافذة الطباعة تلقائياً بعد إتمام البيع.',
  ...
  'Choose which payment options appear during POS checkout': 'اختر طرق الدفع التي تظهر عند إتمام البيع.',
  'Accept physical cash payments': 'قبول المدفوعات النقدية',
  'Credit and debit card payments via POS machine': 'قبول بطاقات الائتمان والخصم عبر جهاز نقطة البيع.',
  ...
  'Orders submitted via WhatsApp from the online catalog': 'الطلبات المرسلة عبر واتساب من الكتالوج الإلكتروني.',
  'Connect your store to Facebook, Google Analytics, and other marketing tools': 'اربط متجرك بفيسبوك وتحليلات Google وأدوات التسويق الأخرى.',
  ...
  'Track customer actions on your catalog for Meta ad retargeting': 'تتبع إجراءات العملاء لإعادة الاستهداف بإعلانات Meta.',
  'Google Analytics 4': 'تحليلات Google 4',
  'Track catalog visitor data and conversion metrics with GA4': 'تتبع بيانات الزوار ومؤشرات التحويل باستخدام GA4.',
  ...
  'Upgrade to Enterprise for multi-store sync, custom API webhooks, and dedicated account manager support.': 'رقِّ إلى خطة المؤسسات لمزامنة عدة متاجر وواجهات API مخصصة ومدير حساب مخصص.',
  'Contact Sales': 'تواصل مع المبيعات',
  'Manage your Dorzak Merchant plan, features, and billing cycle': 'إدارة خطة دورزاك ميرشنت والمزايا ودورة الفوترة.',
...
Object.assign(ar, {
  ...
  'Generate editable Arabic product content from the English details.': 'أنشئ محتوى عربياً قابلاً للتعديل من البيانات الإنجليزية.',
  ...
  'Create groups such as Size and Color, then manage each generated combination.': 'أنشئ مجموعات مثل المقاس واللون ثم أدر كل تركيبة.',
  ...
  'Track confirming orders through preparation and delivery. Completed orders move to Sales History.': 'تابع الطلبات من التأكيد إلى التحضير والتوصيل. تنتقل الطلبات المكتملة إلى سجل المبيعات.',
...
function translateCore(value: string) {
  ...
  if (/^\d+\s+completed sales$/.test(value)) return value.replace('completed sales', 'مبيعات مكتملة');
  ...
  if (/^\d+(?:\.\d+)?%\s+rate applied$/.test(value)) return value.replace('rate applied', 'نسبة مطبقة');
